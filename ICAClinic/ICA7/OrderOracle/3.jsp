   ...
   <td valign="top">
    <table style="">
     ...
     <tr>
      ...
      <td style="background-color: #FFFFFF; border-style: inset; border-width: 0"><a href="OrdersGrid.jsp?item_id=&member_id=&FormOrders_Sorting=1&FormOrders_Sorted=2&"><font style="font-size: 10pt; color: #CE7E00; font-weight: bold">Item</font></a></td>
      <td style="background-color: #FFFFFF; border-style: inset; border-width: 0"><a href="OrdersGrid.jsp?item_id=&member_id=&FormOrders_Sorting=2&FormOrders_Sorted=2&"><font style="font-size: 10pt; color: #CE7E00; font-weight: bold">Member</font></a></td>
      <td style="background-color: #FFFFFF; border-style: inset; border-width: 0"><a href="OrdersGrid.jsp?item_id=&member_id=&FormOrders_Sorting=3&FormOrders_Sorted=2&"><font style="font-size: 10pt; color: #CE7E00; font-weight: bold">Quantity</font></a></td>
     </tr>
     <tr>
